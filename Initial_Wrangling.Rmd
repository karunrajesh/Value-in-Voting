...
From this, we can see that Department of Education's allocated budget increased much faster compared to the Department of Transportation's. We can also see a sharp increase in the Department of Education in 2008, or President Obama's first term. 
...
influence %>%
  ...
  ggplot(aes(state, chance, colour = state)) +
